    ...
    <>
        ...
        options={{
          ...
          headerRight: () => (
            <Text
              ...
              onPress={() => navigate(`/create_update_recipe/?id=${id}`)}
            >
              Edit
            </Text>
          ),
      ...
      <View style={styles.inputBox}>
        ...
        <Text style={{ color: "gray", fontSize: 10 }}>
          {" "}
          Prep: {prepTime.toString()} min | Cooktime: {cookTime.toString()} min
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Text style={{ fontSize: 12, color: "dark gray" }}>
      ...
      <View style={{ flex: 1, alignItems: "center", marginHorizontal: 20 }}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <InstructionListItem instructionItem={item} />
          )}
          showsVerticalScrollIndicator={false}
        />
      </View>
