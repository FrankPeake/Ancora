...
export default function CreateUpdateRecipe() {
    ...
    if (recipeData) {
      ...
      setIngredientsState([
        ...(recipeData.ingredients ?? [
          { name: "", quantity: "0", unit: "", ingredient_id: 1, uom_id: 1 },
        ]),
      ])
      setInstructionsState([
        ...(recipeData.instructions ?? [{ step_number: 1, instruction: "" }]),
      ])
    } else if (!id) {
      // If it's a new recipe (no ID)
  ...
  const handleUpdateIngredient = useCallback(
    (index: number, updatedFields: Partial<RecipeIngredient>) => {
  ...
  const handleUpdateInstruction = useCallback(
    (index: number, updatedFields: Partial<RecipeInstruction>) => {
  ...
  const handleAddIngredient = useCallback(() => {
    setIngredientsState((prev) => [
      ...prev,
      { ingredient_id: 1, uom_id: 1, name: "", quantity: "0", unit: "" },
    ])
  }, [])
  ...
  const handleAddInstruction = useCallback(() => {
    setInstructionsState((prev) => [
      ...prev,
      { instruction: "", step_number: prev.length + 1 },
    ])
  }, [])
        ...
        <View style={styles.inputBox}>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            <TextInput
              ...
              onChangeText={(text) => {
                parseInt(text) ? setPrepTime(text) : setPrepTime("")
              }}
            />
            <View style={styles.divider} />
            <TextInput
              ...
              onChangeText={(text) => {
                parseInt(text) ? setCookTime(text) : setCookTime("")
              }}
            />
            <View style={styles.divider} />
            <TextInput
              ...
              onChangeText={(text) => {
                parseInt(text) ? setServings(text) : setServings("")
              }}
            />
          </View>
          <View style={styles.divider} />
